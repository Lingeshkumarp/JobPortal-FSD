...
function Signup() {
  ...
  const handleLogin = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post('https://jobportal-fsd.onrender.com/signup', { username, email, password });
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-blue-100 to-purple-100">
      <div className="max-w-md w-full bg-[#f8f8ff] p-8 rounded-lg shadow-lg">
        ...
        <div className="mb-4">
          ...
          <button type="submit" className="w-full bg-purple-500 text-white py-2 px-4 rounded hover:bg-purple-600">Sign up</button>
          <div className="flex items-center justify-center mt-4">
          <p className="text-sm text-gray-600">Don't have an account? <Link className="font-medium text-indigo-600 hover:text-indigo-500" to={"/login"}>Login</Link></p>
        </div>
          {/* <div className="flex items-center justify-center mt-4"> */}
